...
-- Add sub_disp_3 column for third level subdisposition (e.g., "Not Resolved" / "Resolved")
ALTER TABLE final_report ADD COLUMN sub_disp_3 VARCHAR(200) DEFAULT NULL AFTER sub_disp_2;

-- Add index for faster lookups on sub_disp_3
ALTER TABLE final_report ADD INDEX idx_sub_disp_3 (sub_disp_3);
